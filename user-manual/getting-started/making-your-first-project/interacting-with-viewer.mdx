...
When you open this new project, you will see see a screen like this.
...
Of course, the most eye-catching part is the [viewer](/user-manual/getting-started/understanding-reearth-ui/editor#viewer) in the center of the screen, where there is an azure blue :earth_africa: that you all know best.
