...
<Order>
  ...
  <List>
    <strong>Public</strong> settings page provides some settings about publishing your project. For more details, please check <Link to="/user-manual/project-and-workspace/project/public-setting">Public Setting</Link>.
  </List>
  <List>
