...
Since each member has their own level of authority (through their roles), it might sometimes be necessary to update a user's role to give (or take away) certain priviledges.
