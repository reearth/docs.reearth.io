...
For more information about the publishing function, please click [here]( /user-manual/1.0/publication/overview).
...
- **Outline**
    ...
    The Outline panel currently manages [Scenes]( /user-manual/1.0/scene/ideas-of-scene), [Widgets]( /user-manual/1.0/widget/overview)and Layers

   To change different aspects of the Scene in the Right Panel click on Select Scene. Please refer to [this page]( /user-manual/1.0/scene/set-up-scene-group-properties) for    details.
