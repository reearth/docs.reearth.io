...
次に、このプラグインをインストールし、マップウィジェットを追加して選択します。右側のパネルにマップブロックのプロパティが表示されます。

![map-plugin](./img/map-plugin.png)

場所を入力すると、Leaflet マップにマーカーが配置されます。

プラグインのマニフェストの詳細については、Re:Earthプロパティを参照してください。
