...
In order to prevent unintended mass deletion of content, in Re:Earth you can delete the workspace only when there is no projects connected to your workspace. In addition, only owners of the workspace are allowed delete priviledges.
